...
%----------Topic 1----------%
%Defining state space - Open Loop
...
t_settling=2;
t_rise=0.3; % 10% -> 90%
p=20; %must be positive because we have considered as real root -p
...
%Omega
omega=4/(t_settling*zeta); % 2% criterion
...
%----------Topic 7----------
%All the data used from now on in this topic, are saved in workspace by
%Simulink
% figure('Name','Disturbance, Control, Response | Topic 7')
% subplot(3,1,1);
...
%All the data used from now on, are saved in workspace by Simulink
figure('Name','Simulink Observer: Control, Response, Error | Topic 9')
subplot(3,1,1);
...
figure('Name','Simulink Observer: Error in States | Topic 9')
